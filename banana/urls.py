...
urlpatterns = patterns('',
    ...
    url(r'^(?P<db>\w+)/skyregions/$',
        ...
        name='skyregions'),
    url(r'^(?P<db>\w+)/frequencyband/$',
        lists.FrequencybandList.as_view(),
        name='frequencybands'),
    ...
    url(r'^(?P<db>\w+)/quality/(?P<pk>\d+)/$',
       ...
       name='quality'),
    url(r'^(?P<db>\w+)/numsource/(?P<pk>\d+)/$',
       details.NumSourceView.as_view(),
       name='numsource'),
    ...
    url(r'^(?P<db>\w+)/bigimage/(?P<pk>\d+)/$',
        ...
        name='bigimage'),
    url(r'^(?P<db>\w+)/js9image/(?P<pk>\d+)/$',
        details.ImageJs9Detail.as_view(),
        name='js9image'),
