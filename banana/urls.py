...
urlpatterns = patterns('',
    ...
    url(r'^(?P<db_name>\w+)/dataset/(?P<dataset_id>\d+)/$',
        models.dataset,
        name='dataset'),
    url(r'^(?P<db_name>\w+)/extractedsource/(?P<pk>\d+)/$',
        models.ExtractedSourceDetail.as_view(),
        name='extractedsource'),
    url(r'^(?P<db_name>\w+)/runningcatalog/(?P<pk>\d+)/$',
        models.RunningcatalogDetail.as_view(),
        name='runningcatalog'),
