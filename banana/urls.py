...
urlpatterns = patterns('',
    ...
    url(r'^(?P<db>\w+)/augmentedrunningcatalogs/$',
        lists.AugmentedRunningcatalogList.as_view(),
        name='augmentedrunningcatalogs'),
    ...
    url(r'^(?P<db>\w+)/runningcatalog/(?P<pk>\d+)/$',
        ...
        name='runningcatalog'),
    url(r'^(?P<db>\w+)/augmentedrunningcatalog/(?P<pk>\d+)/$',
        details.AugmentedRunningcatalogDetail.as_view(),
        name='augmentedrunningcatalog'),
