...
urlpatterns = patterns('',
    ...
    url(r'^(?P<db>\w+)/imageplot/(?P<pk>\d+)/$',
        ...
        name='image_plot'),
    url(r'^(?P<db>\w+)/transientplot/(?P<pk>\d+)/$',
        images.TransientPlot.as_view(),
        name='transient_plot'),
    url(r'^(?P<db>\w+)/runningcatalogplot/(?P<pk>\d+)/$',
        images.RunningcatalogPlot.as_view(),
        name='runningcatalog_plot'),
